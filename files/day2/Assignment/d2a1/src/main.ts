...
import {doc1,doc,users, schedulestorage,confirm} from "./common.js"
...
// import {doc} from 
 ...
 btnlogin.addEventListener("click",() =>
 {
    ...
    doc1('signin').addEventListener("click",() => {
      ...
      let array = schedulestorage.filter((data:any) => data.intervieweremail == interviewemail);
      // console.log(array);
      ...
      let btnconfirm:any = document.querySelectorAll('.confirm');
      for(let confirmbtn of btnconfirm)
      {
        confirmbtn.addEventListener("click",(e:any) =>
        {
          ...
          let scheduledata = schedulestorage.find((data:any) => data.id == valueconfirm[1]);
          console.log(scheduledata.fullname);
          
          let userdata = users.find((data1:any)=>{
